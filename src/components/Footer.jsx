          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+5493765380702" className="hover:text-white transition-colors">3765 38-0702</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-secondary flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="https://www.instagram.com/rmmandados/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">@rmmandados</a>
              </li>
            </ul>
          </div>
        </div>
